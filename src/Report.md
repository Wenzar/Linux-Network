...
- Проверяем на ws22 что соединение появилось
...
- *Remote TCP forwarding* получаем доступ с ws22 на ws11
...
- Проверяем на ws11 что соединение появилось, после "убийства" процесса подключения соединение закрывается
